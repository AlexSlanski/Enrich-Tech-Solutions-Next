...
const TestimonialCard42 = (props) => {
  return (
    <>
      ...
      >
        <svg viewBox="0 0 1024 1024" className="testimonial-card42-icon1">
        ...
        <span className="testimonial-card42-text1">{props.quote}</span>
        <div className="testimonial-card42-profile">
          ...
          <div className="testimonial-card42-container">
            <span className="testimonial-card42-text2">{props.name}</span>
          </div>
        </div>
      </div>
      <style jsx>
        {`
          .testimonial-card42-testimonial-card {
            width: 100%;
            display: flex;
          ...
          .testimonial-card42-icon1 {
            width: var(--dl-layout-size-medium);
            flex-shrink: 0;
            margin-bottom: var(--dl-layout-space-halfunit);
          }
          .testimonial-card42-text1 {
            color: var(--dl-color-gray-500);
            font-size: 1.15rem;
            padding-top: var(--dl-layout-space-threeunits);
            padding-bottom: var(--dl-layout-space-threeunits);
          }
          .testimonial-card42-profile {
            width: 100%;
            display: flex;
            margin-top: auto;
            align-items: center;
          ...
          .testimonial-card42root-class-name1 {
            max-width: auto;
          }
