            ...
            <div className="steps2-container3">
              <div className="steps2-container4 thq-card">
                <h2 className="thq-heading-2">
                  {props.step1Title ?? (
                    <Fragment>
                      <span className="steps2-text29">Contact Us</span>
                    </Fragment>
                  )}
                </h2>
                  ...
                  {props.step1Description ?? (
                    <Fragment>
                      <span className="steps2-text25">
                        Reach out to us via phone or email to discuss your tech
                        support needs.
                      </span>
                    </Fragment>
                  )}
              ...
              <div className="steps2-container5 thq-card">
                <h2 className="thq-heading-2">
                  {props.step2Title ?? (
                    <Fragment>
                      <span className="steps2-text30">Diagnosis</span>
                    </Fragment>
                  )}
                </h2>
                  ...
                  {props.step2Description ?? (
                    <Fragment>
                      <span className="steps2-text32">
                        Our expert technicians will diagnose the issue with your
                        device to determine the best course of action.
                      </span>
                    </Fragment>
                  )}
                </span>
              ...
              <div className="steps2-container6 thq-card">
                <h2 className="thq-heading-2">
                  {props.step3Title ?? (
                    <Fragment>
                      <span className="steps2-text26">Repair or Setup</span>
                    </Fragment>
                  )}
                </h2>
                  ...
                  {props.step3Description ?? (
                    <Fragment>
                      <span className="steps2-text28">
                        We will proceed with the necessary repairs or setup
                  ...
                  {props.step4Description ?? (
                    <Fragment>
                      <span className="steps2-text27">
                        After the service is completed, we provide follow-up
                        support to ensure everything is working smoothly.
                      </span>
                    </Fragment>
                  )}
                </span>
